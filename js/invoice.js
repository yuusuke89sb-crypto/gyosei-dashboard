...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .invoice-office { flex: 1; text-align: right; }
  ...
  .stamp-area {
    ...
    border: 2px solid #c00; border-radius: 50%; margin-top: 8px;
    text-align: center; line-height: 56px; font-size: 11px; color: #c00; font-weight: 700;
  }

  .total-box {
    background: #f8f9fa; border: 2px solid #1a1a2e; border-radius: 8px;
    padding: 16px 24px; margin-bottom: 24px;
    display: flex; justify-content: space-between; align-items: center;
  }
  .total-label { font-size: 16px; font-weight: 700; }
  .total-amount { font-size: 28px; font-weight: 700; }
  .total-amount::before { content: "¥"; font-size: 18px; margin-right: 2px; }

  .date-info {
    display: flex; gap: 24px; margin-bottom: 24px; font-size: 13px;
  }
  .date-info span { font-weight: 600; }

  .section-title {
    font-size: 13px; font-weight: 700; color: #1a1a2e;
    padding: 6px 0; border-bottom: 1px solid #374151;
    margin: 16px 0 8px;
  }
  ...
  .advance-note { font-size: 11px; color: #888; margin-left: 6px; }

  .summary-table { width: 280px; margin-left: auto; margin-bottom: 24px; }
  .summary-table td { padding: 6px 12px; border-bottom: 1px solid #e5e7eb; }
  .summary-table .adv-row td { color: #555; }
  ...
  .bank-title { font-weight: 700; font-size: 13px; margin-bottom: 8px; }
  .bank-grid { display: grid; grid-template-columns: auto 1fr; gap: 4px 16px; line-height: 1.8; }
...
<body>
  ...
  <!-- 立替金明細 -->
  <div class="section-title">【立替金明細】（非課税）</div>
  <table>
    <thead>
      <tr>
        <th style="width:40px">No.</th>
    ...
    <tbody>
      ...
      <tr>
        <td>${i + 1}</td>
        <td>${a.label}</td>
        <td><span class="advance-note">${a.caseTitle}</span></td>
