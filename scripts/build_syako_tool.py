...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .map-layer {
    ...
    z-index: 1;
    filter: grayscale(100%) contrast(105%) brightness(96%);
...
<div class="workspace">
    ...
    <div class="sidebar-section">
      ...
      <div class="property-panel" id="propertyPanel">
        <div class="property-title">
          ...
          <div style="display:flex; gap:4px;">
            <button class="property-btn" style="color:#94A3B8; padding:1px 5px;" onclick="clearSelection()" title="選択を解除 (Esc)">✖ 選択解除</button>
  ...
  <div class="preview-area" id="previewArea">
    ...
    <div class="a4-page-oss" id="page1Sozai" onclick="setActiveTarget('sozai')">
      ...
      <div class="oss-ocr-header">
        <div style="display:flex; align-items:center;">
          <div class="ocr-digits" id="ocrDigitsC">
            <div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">1</div><div class="ocr-digit-cell">1</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">4</div><div class="ocr-digit-cell">7</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">1</div><div class="ocr-digit-cell">5</div><div class="ocr-digit-cell">6</div><div class="ocr-digit-cell">5</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">0</div>
          </div>
    ...
    <div class="a4-page-oss active-edit-target" id="page2Haichi" onclick="setActiveTarget('haichi')">
      ...
      <div class="oss-ocr-header">
        <div style="display:flex; align-items:center;">
          <div class="ocr-digits" id="ocrDigitsD">
            <div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">1</div><div class="ocr-digit-cell">1</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">4</div><div class="ocr-digit-cell">7</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">1</div><div class="ocr-digit-cell">5</div><div class="ocr-digit-cell">6</div><div class="ocr-digit-cell">5</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">0</div><div class="ocr-digit-cell">0</div>
          </div>
...
function initMaps() {
  ...
  sozaiTileLayer = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    minZoom: 3,
    maxZoom: 23,
    maxNativeZoom: 19
  }).addTo(sozaiMap);
  ...
  haichiTileLayer = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    minZoom: 3,
    maxZoom: 23,
    maxNativeZoom: 19
  }).addTo(haichiMap);
